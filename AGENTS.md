...
> project best" headline below does NOT reproduce under a same-config eval. A
...
> The text below is kept as the historical log, not a current capability claim.
...
> **SFT ≈ RL** ("16" not robustly reproducible; RL's real effect is greedy 3→7
> sharpening). Don't treat ≥1-point deltas here as real. See `STRATEGY_2026_06_28.md`.
