# ============================================================================
# VENDORED — SOAP optimizer (Vyas et al., "SOAP: Improving and Stabilizing
# Shampoo using Adam", https://arxiv.org/abs/2409.11321).
#
# Source: https://github.com/nikhilvyas/SOAP  (official implementation)
#   commit a1e553530fde97d0e6b307d7c82ac6d38b072340  (2024-12-02)
#   LICENSE: MIT (Copyright (c) 2024 Nikhil Vyas).
#
# Vendored VERBATIM (only this attribution header added) per the project's
# "no heavy dependency, vendor the .py + cite source" rule. Pure PyTorch
# (torch.linalg.eigh / qr / tensordot) — no custom CUDA, runs on sm_120.
# Wired into experiments/optim_utils.build_optimizer as `--optimizer soap`.
# ============================================================================
import torch
